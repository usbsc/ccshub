...
export const baseTeams: Team[] = [
  ...
  },
  {
    ...
    uniforms: {
      home: { primary: "#FF0000", secondary: "#FFFFFF", description: "Gilroy home uniform" },
      away: { primary: "#FFFFFF", secondary: "#FF0000", description: "Gilroy away uniform" },
      alternate: { primary: "#FFFFFF", secondary: "#FF0000", description: "Gilroy alternate uniform" },
    },
    league: "PCAL - Cypress",
  ...
  },
  {
    ...
    uniforms: {
      home: { primary: "#2E7D32", secondary: "#FFFFFF", description: "San Martin home uniform" },
      away: { primary: "#FFFFFF", secondary: "#2E7D32", description: "San Martin away uniform" },
      alternate: { primary: "#FFFFFF", secondary: "#2E7D32", description: "San Martin alternate uniform" },
    },
    league: "PCAL - Cypress",
    division: "PCAL - Cypress",
    record: {
